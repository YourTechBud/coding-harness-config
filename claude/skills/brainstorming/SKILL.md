...
3. **User experience mapping:** Explore what using the chosen solution should be like, including how it is presented, how users interact with it, and what feedback they receive, so the experience is understandable, convenient, and enjoyable. Consider the whole experience, from discovery and entry through task completion and recovery from problems, while adapting discussion depth to the topic's consequential or uncertain parts and building on what is already understood. Develop enough shared understanding of the experience to inform program design; when experience needs challenge the chosen approach, surface the conflict and agree with the user on revisiting solution shaping.
4. **Program design:** Explore how the chosen approach should work, including consequential behavior, component interactions, data and state, contracts, and failure cases. Resolve design questions together within the agreed architectural direction and intended user experience.
